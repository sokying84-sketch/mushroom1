...
import { LogOut, Menu, X, LayoutDashboard, Settings, Package, BadgeDollarSign, FolderOpen } from 'lucide-react';
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      `}>
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <div className="text-xs font-semibold text-earth-500 uppercase tracking-wider mb-2 px-4 mt-6">Workspace</div>
          <NavButton 
             id="documents" 
             label="My Documents" 
